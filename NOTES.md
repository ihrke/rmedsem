...
- also add bias-corrected bootstrap and accelerated bias-corrected
  bootstrap (see Preacher & Selig, 2012)

## Standard errors

- Stata uses OIM (observed information matrix) for estimating standard
  errors by default
