...
mediated
moderation](https://ihrke.github.io/rmedsem/articles/moderated_mediation.md)
models using the [modsem](https://modsem.org) package.

Currently, only continuous independent and mediator variables are
supported. See [this
article](https://ihrke.github.io/rmedsem/articles/mediation_technical.md)
for technical details on the estimation procedure used.

See the examples in the section below and refer to the
...
article](https://ihrke.github.io/rmedsem/articles/estimation_methods.md).
...
([`summary()`](https://rdrr.io/r/base/summary.html) etc). To run the
mediation analysis, we use
[`rmedsem()`](https://ihrke.github.io/rmedsem/reference/rmedsem.md) and
...
details](https://ihrke.github.io/rmedsem/articles/mediation_technical.md))
...
We can also apply
[`rmedsem()`](https://ihrke.github.io/rmedsem/reference/rmedsem.md) to
more complex SEM’s that contain both latent and observed variables:
...
![](reference/figures/README-unnamed-chunk-9-1.png) Here, we have latent
variables `Appearance`, `Attractiveness`, `Muscle` and `Weight` that
measure the motivation of people going to a gym to workout.

This model features several complex mediation pathways. We can use
[`rmedsem()`](https://ihrke.github.io/rmedsem/reference/rmedsem.md) to
investigate those one by one. We start by considering the pathway
`Attractive` -\> `Appearance` -\> `Muscle` (the more attractive the
person perceives her/himself, the more this will indirectly influence
her/him to want to work out more to build up muscles):
...
packages/estimation
techniques](https://ihrke.github.io/rmedsem/articles/estimation_methods.md)
to fit the models.
