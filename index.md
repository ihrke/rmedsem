...
sizes is provided by [`summary()`](https://rdrr.io/r/base/summary.html):
...
e.g. [`coef()`](https://rdrr.io/r/stats/coef.html) for the indirect,
direct and total effects and
[`confint()`](https://rdrr.io/r/stats/confint.html) for their intervals
(see [this
...
![](reference/figures/README-unnamed-chunk-11-1.png) Here, we have
latent variables `Appearance`, `Attractiveness`, `Muscle` and `Weight`
that measure the motivation of people going to a gym to workout.
