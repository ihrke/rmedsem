...
# Point estimates taken from MBESS::upsilon() and patched to work with new
# lavaan: the original used lavaan::lavInspectSampleCov(), which was removed,
# and is replaced by lavaan::lavInspect(mod, "sampstat")$cov. The bootstrap
# branches of the original are not needed here and were removed.
upsilon_mbess_patched <- function(x, mediator, dv) {
